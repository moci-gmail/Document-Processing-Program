...
translations = {
    "中文": {
        "page_title": "Document Processing Program - AI文档规范化工具",
        "title": "Document Processing Program - AI文档规范化自动化工具",
        ...
        "footer1": "© 2026 Document Processing Program - 轻量级文档规范化工具",
    ...
    "繁體中文": {
        "page_title": "Document Processing Program - AI文檔規範化工具",
        "title": "Document Processing Program - AI文檔規範化自動化工具",
        ...
        "footer1": "© 2026 Document Processing Program - 輕量級文檔規範化工具",
    ...
    "English": {
        "page_title": "Document Processing Program - AI Document Normalization Tool",
        "title": "Document Processing Program - AI Document Normalization Automation Tool",
        ...
        "footer1": "© 2026 Document Processing Program - Lightweight Document Normalization Tool",
